...
- [x] translate 286 untranslated i18n keys across de/fr/he/uk — titles, labels, section headings, short descriptions for LLM help, Hooks help, TTS help, FAQ, compare, settings, and UI elements; reduced untranslated count from 688 to 408 (remaining are long help body paragraphs)
