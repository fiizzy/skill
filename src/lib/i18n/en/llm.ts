...
const llm: Record<string, string> = {
  ...
  "model.reembedDesc":            "Tag all historical embeddings with model metadata. Future recordings will use the selected backend.",
  "model.reembedBtn":             "Tag historical data",
  "model.reembedEstimate":        "{days} days, {rows} embeddings",
