...
<!-- EXG tab — OpenBCI config, signal processing, EEG embedding, GPU stats. -->
<script lang="ts">
...
<section class="flex flex-col gap-4">
  ...
  <div class="rounded-2xl border border-border dark:border-white/[0.06]
              ...
              dark:from-emerald-500/15 dark:via-teal-500/15 dark:to-cyan-500/15
              px-5 py-4 flex items-center gap-4">
    <div class="flex items-center justify-center w-11 h-11 rounded-xl
                bg-gradient-to-br from-emerald-500 to-teal-500
                shadow-lg shadow-emerald-500/25 dark:shadow-emerald-500/40 shrink-0">
    ...
    <div class="flex flex-col gap-0.5">
      <span class="text-[0.82rem] font-bold">{t("exg.title")}</span>
