...
- **History page helper extraction**: Extracted types, constants, date helpers, format utilities, label analysis, and grid constants from `history/+page.svelte` (2332 lines) into `history-helpers.ts` (206 lines). The main page is now 2224 lines.
